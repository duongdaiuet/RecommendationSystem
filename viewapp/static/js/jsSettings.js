...
function connect() {
    // var roomName = '9afc8d1c-7ffe-442e-98e9-39832d330194';
    // var user_name = 'tnv';

    var user_name = $("#dropdown-user-details-user-uuid-d-none").html();
    // var roomName = 'phongit';
    // chatSocket = new WebSocket("ws://" + window.location.host + "/ws/notice-signal/" + roomName + "/");
    chatSocket = new WebSocket("ws://" + window.location.host + "/ws/user/" + user_name + "/notice/");
